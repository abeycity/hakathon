...
import './global.css'
import user from '../h-images/user.png'
  ...
  return (
    <nav className='navbar'>
        <div className='nav-container'>
         { !ismobileview ?  <div className='container' onClick={()=>{setIsMobileView(!ismobileview)}}>
              <h3>dashboard</h3>
            </div>:<div className='mobile-sidebar'> <section className='-mobile-sidebar-components'>
  
  <div className='mobile-sidebar-cont'>
   <div className="upper-cont" >
       <ul onClick={()=>{setIsMobileView(!ismobileview)}}>
         {upperSideData.map((items)=><li key={items.img}> <a href="?#"> {items.img} </a> </li>)}
       </ul>
       <div className='moon-bright-cont'>
      
          <div className='brightness-cont'>
           <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 18 18" fill="none">
               ...
               <path d="M9 3.09345C8.53363 3.09345 8.15625 2.71564 8.15625 2.2497V1.40625C8.15625 0.940309 8.53363 0.5625 9 0.5625C9.46637 0.5625 9.84375 0.940309 9.84375 1.40625V2.2497C9.84375 2.71564 9.46637 3.09345 9 3.09345Z" fill="white"/>
               <path d="M13.7734 5.07056C13.5576 5.07056 13.3417 4.98816 13.1769 4.82336C12.8473 4.49387 12.8473 3.95964 13.1769 3.63015L13.7734 3.03369C14.103 2.7043 14.637 2.7042 14.9666 3.03379C15.2961 3.36328 15.2961 3.89751 14.9666 4.227L14.37 4.82346C14.2052 4.98816 13.9893 5.07056 13.7734 5.07056Z" fill="white"/>
               <path d="M16.5937 9.84375H15.75C15.2836 9.84375 14.9062 9.46594 14.9062 9C14.9062 8.53406 15.2836 8.15625 15.75 8.15625H16.5937C17.0601 8.15625 17.4375 8.53406 17.4375 9C17.4375 9.46594 17.0601 9.84375 16.5937 9.84375Z" fill="white"/>
               <path d="M14.37 15.2133C14.1541 15.2133 13.9382 15.131 13.7734 14.9662L13.1769 14.3698C12.8473 14.0403 12.8473 13.5061 13.1769 13.1766C13.5065 12.847 14.0404 12.8469 14.37 13.1765L14.9666 13.7729C15.2961 14.1024 15.2961 14.6366 14.9666 14.9661C14.8018 15.1309 14.5859 15.2133 14.37 15.2133Z" fill="white"/>
               <path d="M9 17.4374C8.53363 17.4374 8.15625 17.0596 8.15625 16.5937V15.7502C8.15625 15.2843 8.53363 14.9065 9 14.9065C9.46637 14.9065 9.84375 15.2843 9.84375 15.7502V16.5937C9.84375 17.0596 9.46637 17.4374 9 17.4374Z" fill="white"/>
               ...
               <path d="M2.25 9.84375H1.40625C0.93988 9.84375 0.5625 9.46594 0.5625 9C0.5625 8.53406 0.93988 8.15625 1.40625 8.15625H2.25C2.71637 8.15625 3.09375 8.53406 3.09375 9C3.09375 9.46594 2.71637 9.84375 2.25 9.84375Z" fill="white"/>
     ...
     <div className="lower-cont">
       <ul>
       {lowersideData.map((items)=><li key={items.img}> <a href="?#"> {items.img} </a> </li>)}
       </ul>
     </div>
  </div>
 </section></div>
            ...
            <div className='nav-conts'>
          { !ismobileview ?  <div className="search-container">
                    <FontAwesomeIcon icon={faSearch} className='search'/>
                      <input type="text" placeholder="search" />
                </div>: <div>
              { !togglesearchbar  ?  <FontAwesomeIcon icon={faSearch} className='search' onClick={searchClick}/>
                : <div>
               <div className="mobile-search-container">
                    <FontAwesomeIcon icon={faSearch} className='search' onClick={searchClick} />
                      <input type="text" placeholder="search" />
                </div> 
                </div>}
                </div> }
                ...
                <div className='users'>
                  <div className='user-dashboard-cont' onClick={HandleDrop}>
                   <div className='user-container'>
                      <div>
                      <img src={user} alt='user'/>
                      </div>
                      <div className='username'> 
                        <main>Justin Bergson</main>
                          <small>Justin@gmail.com</small>
                      </div>
                    </div>
                    {isOpen ? <FontAwesomeIcon icon={faAngleUp} className='fontaewsome'/> : <FontAwesomeIcon icon={faAngleDown}/>
                     }
                  </div>
                 { !ismobileview ? 
                   <div>
                  ...
                  <div className='dashboard-dropdown'>
                    <ul>
                      <li><a href='?#' className='drop'>profile</a></li>
                      <li><a href="?#" className='drop'>goals</a></li>
                      <li><a href="?#" className='drop'>sales</a></li>
                      <li><a href="?#" className='drop'>transactions</a></li>
                    </ul>
                  </div>: null} </div>:
                  <div>
                  { isOpen ?
